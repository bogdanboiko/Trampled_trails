...
fun syncPrivateRoutesFragmentTheme(theme: MyAppTheme, binding: FragmentPrivateRouteBinding, context: Context) {
    ...
    with(binding) {
        if (theme.id() == 0) {
            mapRoutePointModSwitcher.setImageResource(com.example.trampled_trails.R.drawable.ic_routes_light)
            homepageButton.setImageResource(com.example.trampled_trails.R.drawable.ic_home_light)

            pointTypeSwitchButton.setSwitchToggleCheckedDrawableRes(com.example.trampled_trails.R.drawable.ic_pin_route_rotated_light)
            pointTypeSwitchButton.setSwitchToggleNotCheckedDrawableRes(com.example.trampled_trails.R.drawable.ic_pin_point_rotated_light)
        } else {
            mapRoutePointModSwitcher.setImageResource(com.example.trampled_trails.R.drawable.ic_routes_dark)
            homepageButton.setImageResource(com.example.trampled_trails.R.drawable.ic_home_dark)

            pointTypeSwitchButton.setSwitchToggleCheckedDrawableRes(com.example.trampled_trails.R.drawable.ic_pin_route_rotated_dark)
            pointTypeSwitchButton.setSwitchToggleNotCheckedDrawableRes(com.example.trampled_trails.R.drawable.ic_pin_point_rotated_dark)
        }
