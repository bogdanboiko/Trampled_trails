...
fun syncPrivatePointsFragmentTheme(theme: MyAppTheme, binding: FragmentPrivatePointsBinding, context: Context) {
    ...
    with(binding) {
        if (theme.id() == 0) {
            mapRoutePointModSwitcher.setImageResource(com.example.gh_coursework.R.drawable.ic_points_light)
            homepageButton.setImageResource(com.example.gh_coursework.R.drawable.ic_home_light)
            centralPointer.setImageResource(com.example.gh_coursework.R.drawable.ic_pin_point_light)
        } else {
            mapRoutePointModSwitcher.setImageResource(com.example.gh_coursework.R.drawable.ic_points_dark)
            homepageButton.setImageResource(com.example.gh_coursework.R.drawable.ic_home_dark)
            centralPointer.setImageResource(com.example.gh_coursework.R.drawable.ic_pin_point_dark)
        }
