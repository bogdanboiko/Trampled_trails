...
fun mapPointDomainToModel(point: PointPreviewDomain): PrivateRoutePointModel {
    return PrivateRoutePointModel(point.pointId, point.x, point.y, point.isRoutePoint)
}